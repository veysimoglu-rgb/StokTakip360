...
<body class="font-sans antialiased bg-gray-50">
    <div x-data="{ sidebarOpen: false }" class="min-h-screen flex">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            <header class="h-16 bg-white border-b flex items-center justify-between gap-3 px-4 lg:px-8">
                ...
                <h1 class="app-header-title text-lg font-semibold text-gray-800">{{ $title ?? 'Ana Sayfa' }}</h1>
                <x-header-info />
            </header>
