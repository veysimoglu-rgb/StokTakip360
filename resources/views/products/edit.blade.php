    ...
    <div class="bg-white rounded-lg shadow p-6 max-w-3xl">
        <form method="POST" action="{{ route('products.update', $product) }}" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <x-text-input id="min_stock" type="number" min="0" name="min_stock" value="{{ old('min_stock', $product->min_stock) }}" class="w-full" required />
            ...
            <div>
                ...
                <p class="mt-2 text-lg font-semibold">{{ $product->current_stock }} {{ $product->unit }}</p>
